...
/**
 * Remove unecessary datum in body_class.
 *
 * @param string $wpclass Default classes for `body_class()`
 * @param string $otclass Other classes for `body_class()`
...
function _cw_clean_body_class($wpclass, $otclass)
{
    ...
    if (is_author()) {
        ...
        //Remove classes
        $wpclass = array_diff($wpclass, $removed);
    }

    //Return all classes
    return array_merge($wpclass, (array)$otclass);
}
